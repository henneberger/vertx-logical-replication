...
final class CassandraReplicationOptionsConverter {

  private CassandraReplicationOptionsConverter() {
  }

  static void fromJson(JsonObject json, CassandraReplicationOptions options) {
    if (json == null) {
      return;
    }
  ...
  static void toJson(CassandraReplicationOptions options, JsonObject json) {
