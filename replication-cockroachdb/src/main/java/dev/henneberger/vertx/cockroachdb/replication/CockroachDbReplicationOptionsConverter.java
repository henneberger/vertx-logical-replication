...
final class CockroachDbReplicationOptionsConverter {
  private CockroachDbReplicationOptionsConverter() { }

  static void fromJson(JsonObject json, CockroachDbReplicationOptions options) {
    if (json == null) return;
  ...
  static void toJson(CockroachDbReplicationOptions options, JsonObject json) {
