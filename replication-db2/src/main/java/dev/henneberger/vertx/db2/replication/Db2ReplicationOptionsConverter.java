...
final class Db2ReplicationOptionsConverter {
  private Db2ReplicationOptionsConverter() { }

  static void fromJson(JsonObject json, Db2ReplicationOptions options) {
    if (json == null) return;
  ...
  static void toJson(Db2ReplicationOptions options, JsonObject json) {
