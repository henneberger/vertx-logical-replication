...
final class OracleReplicationOptionsConverter {
  private OracleReplicationOptionsConverter() { }

  static void fromJson(JsonObject json, OracleReplicationOptions options) {
    if (json == null) return;
  ...
  static void toJson(OracleReplicationOptions options, JsonObject json) {
